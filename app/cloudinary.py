...
def upload_to_cloudinary(file_path: str, cloud_name: Optional[str] = None, api_key: Optional[str] = None, api_secret: Optional[str] = None) -> dict:
    """
    ...
    try:
        ...
        # Use official Cloudinary SDK for upload (synchronous)
...
def upload_chart_to_cloudinary(fig_obj, filename: str, width: int = 1000, height: int = 600) -> dict:
    """
    ...
    try:
        ...
        fig_obj.write_image(temp_file, width=width, height=height)
        
        # Upload to Cloudinary
        result = upload_to_cloudinary(temp_file)
